...
export const executeCode = async(req,res)=>{
    try {
        ...
        // step5 : Analyse the test case results
        let allPassed = true;
        ...
        //step6:  store submission summary in db
        ...
        //step7: If all passed -> true mark problem as solved for the current user
        if(allPassed){
        ...
        //step8: Save individual test case results using detailedResults
